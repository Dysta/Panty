	...
	<td class="text">
		...
		<table>
			<tr>
				...
				<td class="text">
					<center>Veuillez vérifier les informations de la commande avant de continuer. Lisez bien les informations de cette page, elles peuvent vous étre utiles.</center>
					<br /><br />
						...
						<form method="post">
							<table>
								<tbody>
									...
									<tr>
										<td>
											<center><input type="radio" name="character" value="{$char.id}"></center>
										</td>
										<td>
											<b>
							...
							<br />
							<center><input class="btn btn-danger" type="submit" name="" value="Confirmer l'achat !" type="submit"/></center>
						</form>
					</center>
				</td>
			</tr>
