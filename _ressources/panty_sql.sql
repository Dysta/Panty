...
INSERT INTO `panty_news` VALUES ('5', 'Bienvenue sur Panty_r16 ! ', 'Si vous voyez cette page, c\'est que vous avez correctement installé le CMS Panty.<br />\r\nPanty_r16 a été conçu par Dysta sur la base des travaux de Ramlethal<br />\r\n<br />\r\nPanty_r16 contient un système de logs. Dans ce système de log vous pouvez trouver un historique d\'achat de point et un historique d\'achat d\'objet en boutique. Il est très simplet mais assez complet.<br />Cette version bloque également l\'aspiration du site avec les logiciels. Vous pouvez désormais garder votre template privé !<br /><br />Je pense en avoir fini avec le développement publique de ce CMS. Merci de votre utilisation.<br />\r\n<br />\r\nDysta', 'Dysta', '3');
